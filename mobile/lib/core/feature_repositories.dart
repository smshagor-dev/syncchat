...
class InboxRepository {
  ...
  Future<void> verifyChatLock(String roomId, String password) async {
    await _api.post('/inboxes/$roomId/verify-lock', body: {'password': password});
  }
  ...
  Future<void> removeChatLock(String roomId, String password) async {
    await _api.delete('/inboxes/$roomId/chat-lock', body: {'password': password});
  }
}
...
class ContactRepository {
  ...
  Future<List<Map<String, dynamic>>> search(String query) async =>
      _mapList((await _api.get('/contacts/search', query: {'q': query})).payload);
  ...
  Future<Map<String, dynamic>> createLabel(String name) async =>
      _mapPayload(
  ...
  Future<Map<String, dynamic>> syncMobile(
    List<Map<String, dynamic>> contacts,
      ...
      _mapPayload(
        (await _api.post('/contacts/mobile-sync', body: {'contacts': contacts}))
            .payload,
      );
...
class ChannelRepository {
  ...
  Future<List<Map<String, dynamic>>> list({String? mode}) async =>
      _mapList(
        (await _api.get(
          '/channels',
  ...
  Future<List<Map<String, dynamic>>> pendingMembers(String channelId) async =>
      _mapList((await _api.get('/channels/$channelId/pending-members')).payload);
  ...
  Future<Map<String, dynamic>> joinByLink(String token) async =>
      _mapPayload(
